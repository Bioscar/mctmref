...
where **a**<sub>r</sub> and **b**<sub>r</sub> are Bernstein basis vectors of order 6, **ν**<sub>r</sub> are response-specific coefficients, and **β**<sub>r</sub> capture the effect of gender and age on the marginal distributions (for r = 1, 2).
