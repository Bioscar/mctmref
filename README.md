...
h₂(HbA1c | Age) = **a**₂(HbA1c)^T ν₂ − **b**₂(Age) β₂


where $\mathbf{a}_r$ and $\mathbf{b}_r$ are Bernstein basis vectors of
order 6, $\boldsymbol{\nu}_{r}$ are response-specific coefficients, and
$\boldsymbol{\beta}_r$ capture the effect of gender and age on the
marginal distributions (for $r = 1, 2$).
...
$$R_\tau(x) = \tilde{h}^{-1}(Z : Z^\top \Sigma(x)^{-1} Z \leq \chi^2_2(\tau))$$
...
devtools::install_github("Bioscar/mctmref")
```
...
<img src="README_files/unnamed-chunk-1-1.png" alt="Scatterplot glycemic markers"/>

<figcaption aria-hidden="true">

Scatterplot glycemic markers
...
-   `bounds_y1`, `bounds_y2`: hard lower and upper bounds for the
    Bernstein basis support. Should be slightly wider than the data
    range.
...
<img src="github_readme_files/figure-gfm/correlation-1.png" style="display: block; margin: auto;"/>

<figure>

<img src="README_files/correlation-1.png" alt="Conditional Correlation"/>
...
<img src="github_readme_files/figure-gfm/percentiles-1.png" style="display: block; margin: auto;"/>
...
<img src="README_files/percentiles-1.png" alt="Conditional Percentiles"/>
...
<img src="github_readme_files/figure-gfm/bivreg-single-1.png" style="display: block; margin: auto;"/>

<figure>

<img src="README_files/bivreg-single-1.png" alt="Conditional Reference Region (age = 50 years)"/>

<figcaption aria-hidden="true">

Conditional Reference Region (age = 50 years)
...
<img src="github_readme_files/figure-gfm/bivreg-ages-1.png" style="display: block; margin: auto;"/>
...
<img src="README_files/bivreg-ages-1.png" alt="Conditional Reference Region (several ages)"/>

<figcaption aria-hidden="true">

Conditional Reference Region (several ages)
...
<img src="github_readme_files/figure-gfm/bivreg-multitau-1.png" style="display: block; margin: auto;"/>

<figure>

<img src="README_files/bivreg-multitau-1.png" alt="Conditional Reference Region (several ages)"/>
...
<img src="github_readme_files/figure-gfm/tolerance-1.png" style="display: block; margin: auto;"/>

<figure>

<img src="README_files/tolerance-1.png" alt="Conditional Tolerance Regions (50 years)"/>

<figcaption aria-hidden="true">

Conditional Tolerance Regions (50 years)
...
<img src="github_readme_files/figure-gfm/zscores-plot-1.png" style="display: block; margin: auto;"/>
...
<img src="README_files/zscores-plot-1.png" alt="Transformed observations adjusted by age"/>

<figcaption aria-hidden="true">

Transformed observations adjusted by age
...
<img src="github_readme_files/figure-gfm/unnamed-chunk-4-1.png" style="display: block; margin: auto;"/>

<figure>

<img src="README_files/unnamed-chunk-4-1.png" alt="Transformed observations adjusted by age"/>
...
<img src="README_files/mahalanobis-plot-1.png" alt="Mahalanobis Distance From Data Center for Each point Along Age"/>

<figcaption aria-hidden="true">

Mahalanobis Distance From Data Center for Each point Along Age
